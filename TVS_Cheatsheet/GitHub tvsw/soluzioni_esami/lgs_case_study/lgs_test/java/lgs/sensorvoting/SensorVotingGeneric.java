...
public class SensorVotingGeneric<E> {
	 ...
	 * @return
	 */
	public void computeSensorValue(E s1, E s2, E s3) {
		if (valid) {
			if (valid1 && valid2 && valid3) {
				...
				} else if (!s2.equals(s1) && s1.equals(s3)) {
					// s2 invalid
					valid2 = false;
					value = s3;
					System.out.println("s2 invalid");
				} else if (!s3 .equals(s1) && s1.equals(s2)) {
					// s3 invalid
					valid3 = false;
					value = s1;
